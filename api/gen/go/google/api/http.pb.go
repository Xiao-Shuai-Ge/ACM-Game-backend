...
type HttpRule struct {
	...
	AdditionalBindings []*MediaType       `protobuf:"bytes,11,rep,name=additional_bindings,json=additionalBindings,proto3" json:"additional_bindings,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *HttpRule) GetAdditionalBindings() []*MediaType {
	if x != nil {
...
func (x *MediaType) Reset() {
	*x = MediaType{}
	mi := &file_google_api_http_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MediaType) Descriptor() ([]byte, []int) {
	return file_google_api_http_proto_rawDescGZIP(), []int{3}
}
...
const file_google_api_http_proto_rawDesc = "" +
	...
	"\x1ffully_decode_reserved_expansion\x18\x02 \x01(\bR\x1cfullyDecodeReservedExpansion\"\xdb\x02\n" +
	"\bHttpRule\x12\x1a\n" +
	...
	"\x13additional_bindings\x18\v \x03(\v2\x15.google.api.MediaTypeR\x12additionalBindingsB\t\n" +
	"\apattern\";\n" +
	...
	"\asubtype\x18\x02 \x01(\tR\asubtypeB1Z/acmgame-backend/api/gen/go/google/api;googleapib\x06proto3"
...
var file_google_api_http_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_api_http_proto_goTypes = []any{
	...
	(*MediaType)(nil),         // 3: google.api.MediaType
}
var file_google_api_http_proto_depIdxs = []int32{
	...
	3, // 2: google.api.HttpRule.additional_bindings:type_name -> google.api.MediaType
