...
import (
	_ "acmgame-backend/api/gen/go/google/api"
...
const file_platform_v1_platform_proto_rawDesc = "" +
	"\n" +
	"\x1aplatform/v1/platform.proto\x12\x13acmgame.platform.v1\x1a\x1cgoogle/api/annotations.proto\"\r\n" +
	"\vPingRequest\"(\n" +
	"\fPingResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2y\n" +
	"\x0fPlatformService\x12f\n" +
	"\x04Ping\x12 .acmgame.platform.v1.PingRequest\x1a!.acmgame.platform.v1.PingResponse\"\x19\x82\xd3\xe4\x93\x02\x13\x12\x11/platform/v1/pingB3Z1acmgame-backend/api/gen/go/platform/v1;platformv1b\x06proto3"
...
var file_platform_v1_platform_proto_goTypes = []any{
	(*PingRequest)(nil),  // 0: acmgame.platform.v1.PingRequest
	(*PingResponse)(nil), // 1: acmgame.platform.v1.PingResponse
}
var file_platform_v1_platform_proto_depIdxs = []int32{
	0, // 0: acmgame.platform.v1.PlatformService.Ping:input_type -> acmgame.platform.v1.PingRequest
	1, // 1: acmgame.platform.v1.PlatformService.Ping:output_type -> acmgame.platform.v1.PingResponse
